        ...
        <div class="bg-white shadow-lg rounded-xl overflow-hidden">
          <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-4">
            <div class="flex tablecss justify-between items-center">
              <h1 class="text-2xl textbot font-bold text-white">Resume Preview</h1>
          ...
          <div class="p-6">
            <div class="mb-8">
              ...
              <select id="resume-select" v-model="selectedResumeId"
              ...
              <div class="bg-white rounded-lg shadow-sm p-8">
                <div id="resume-content" class="space-y-8">
                  ...
                  <div>
                    ...
                    <div class="space-y-6">
                      <div v-for="(exp, index) in selectedResume.experience" :key="index"
                  ...
                  <div>
                    ...
                    <div class="space-y-6">
                      <div v-for="(edu, index) in selectedResume.education" :key="index"
                        class="border-l-4 border-indigo-500 pl-4">
...
const fetchResumes = async () => {
  try {
    ...
    if (route.params.id) {
      selectedResumeId.value = route.params.id;
...
const downloadPDF = () => {
  ...
  const opt = {
    margin: 1,
    filename: `${selectedResume.value.fullName.replace(/\s+/g, '_')}_resume.pdf`,
